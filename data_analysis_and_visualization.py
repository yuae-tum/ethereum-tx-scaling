...
def dataAnalysisAndVisualization():
	...
	m2_throughput_fig = generateFig(['a1', 'a2', 'a3', 'a4-100' ,'a4-1000', 'a4-10000'], [m2_throughput_list[0][0], m2_throughput_list[1][0], m2_throughput_list[2][0], 0, m2_throughput_list[4][0], m2_throughput_list[3][0]], "Throughput m=2")
	m2_throughput_fig.show()
	m2_per_machine_throughput_fig = generatePerMachineFig(['a1', 'a2', 'a3', 'a4-100', 'a4-1000', 'a4-10000'], ['m1', 'm2'], [[m2_throughput_list[0][1], m2_throughput_list[0][2]], [m2_throughput_list[1][1], m2_throughput_list[1][2]], [m2_throughput_list[2][1], m2_throughput_list[2][2]], [0, 0], [m2_throughput_list[4][1], m2_throughput_list[4][2]], [m2_throughput_list[3][1], m2_throughput_list[3][2]]], "Throughput per machine m=2")
	m2_per_machine_throughput_fig.show()
	m3_throughput_fig = generateFig(['a1', 'a2', 'a3', 'a4-100' ,'a4-1000', 'a4-10000'], [m3_throughput_list[0][0], m3_throughput_list[1][0], m3_throughput_list[2][0], m3_throughput_list[4][0], 0, m3_throughput_list[3][0]], "Throughput m=3")
	m3_throughput_fig.show()
	m3_per_machine_throughput_fig = generatePerMachineFig(['a1', 'a2', 'a3', 'a4-100', 'a4-1000', 'a4-10000'], ['m1', 'm2', 'm3'], [[m3_throughput_list[0][1], m3_throughput_list[0][2], m3_throughput_list[0][3]], [m3_throughput_list[1][1], m3_throughput_list[1][2], m3_throughput_list[1][3]], [m3_throughput_list[2][1], m3_throughput_list[2][2], m3_throughput_list[2][3]], [0, 0, 0], [m3_throughput_list[4][1], m3_throughput_list[4][2], m3_throughput_list[4][3]], [m3_throughput_list[3][1], m3_throughput_list[3][2], m3_throughput_list[3][3]]], "Throughput per machine m=3")
	...
	m1_latency_fig.show()
	m2_latency_fig = generateFig(['a1', 'a2', 'a3', 'a4-100' ,'a4-1000', 'a4-10000'], [m2_latency_list[0][0], m2_latency_list[1][0], m2_latency_list[2][0], 0, m2_latency_list[4][0], m2_latency_list[3][0]], "Latency m=2")
	m2_latency_fig.show()
	m2_per_machine_latency_fig = generatePerMachineFig(['a1', 'a2', 'a3', 'a4-100', 'a4-1000', 'a4-10000'], ['m1', 'm2'], [[m2_latency_list[0][1], m2_latency_list[0][2]], [m2_latency_list[1][1], m2_latency_list[1][2]], [m2_latency_list[2][1], m2_latency_list[2][2]], [0, 0], [m2_latency_list[4][1], m2_latency_list[4][2]], [m2_latency_list[3][1], m2_latency_list[3][2]]], "latency per machine m=2")
	m2_per_machine_latency_fig.show()
	m2_latency_fig = generateFig(['a1', 'a2', 'a3', 'a4-100' ,'a4-1000', 'a4-10000'], [m3_latency_list[0][0], m3_latency_list[1][0], m3_latency_list[2][0], m3_latency_list[4][0], 0, m3_latency_list[3][0]], "Latency m=3")
	m2_latency_fig.show()
	m3_per_machine_latency_fig = generatePerMachineFig(['a1', 'a2', 'a3', 'a4-100', 'a4-1000', 'a4-10000'], ['m1', 'm2', 'm3'], [[m3_latency_list[0][1], m3_latency_list[0][2], m3_latency_list[0][3]], [m3_latency_list[1][1], m3_latency_list[1][2], m3_latency_list[1][3]], [m3_latency_list[2][1], m3_latency_list[2][2], m3_latency_list[2][3]], [0, 0, 0], [m3_latency_list[4][1], m3_latency_list[4][2], m3_latency_list[4][3]], [m3_latency_list[3][1], m3_latency_list[3][2], m3_latency_list[3][3]]], "latency per machine m=3")
