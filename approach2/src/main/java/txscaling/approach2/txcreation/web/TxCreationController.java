package txscaling.approach2.txcreation.web;

import txscaling.approach2.txcreation.service.TxCreationService;
...
public class TxCreationController {
    ...
    @Autowired
    public TxCreationController(Web3jConfiguration config, TxCreationService service) {
        this.config = config;
